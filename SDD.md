...
- §6 Core Ontology — glossary: Field, Concept, Zone, Pattern, Material(Part), Encounter, Artifact, Probe, Question, Route, Trail, Influence, State, Frontier; canonical kind list; avoid-synonyms and flagged ambiguities (§6.1)
